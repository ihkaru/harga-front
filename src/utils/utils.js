...
export function useUtils() {
  ...
  function transformDataArray(dataArray) {
    ...
    const komoditasInfo = {
      ...
      "Bawang Merah,1 kg": { symbol: "BM", icon: "fas fa-onion" },
      ...
      "Bawang Putih Honan,1 kg": { symbol: "BPH", icon: "fas fa-garlic" },
      "Bawang Bombai,1 kg": { symbol: "BB", icon: "fas fa-onion" },
      "Garam Halus,1 kg": { symbol: "GH", icon: "fas fa-salt-shaker" },
